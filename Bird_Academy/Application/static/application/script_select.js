document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateSelectedOptions(customSelect) {
        const selectedOptions = Array.from(customSelect.querySelectorAll(".option.active"))
            .filter(function(option) {
                return option !== customSelect.querySelector(".option.all-tags");
            })
            .map(function(option) {
                return {
    ...
    customSelects.forEach(function(customSelect) {
        ...
        searchInput.addEventListener("input", function() {
            ...
            const anyOptionsMatch = Array.from(options).some(function(option) {
    ...
    // Met à jour les options sélectionnées pour chaque custom select
    customSelects.forEach(function(customSelect) {
        updateSelectedOptions(customSelect);
    });
...
console.log("Hello les oiseaux !3");
